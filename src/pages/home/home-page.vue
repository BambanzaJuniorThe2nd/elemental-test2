<template>
  <div
    class="w-11/12 mt-2 mx-auto overflow-x-auto relative shadow-md sm:rounded-lg"
  >
...
import { refreshData, getFormattedCategories } from "../util";

const computedCategories = computed(() => {
  return getFormattedCategories(store.categories.value);
});
onMounted(async () => {
  try {
    refreshData();
